...
- [White-label & SEO conventions](white-label-and-seo.md) — user wants zero "Replit" mentions in shipped code/comments; SEOMeta/sitemap/robots.txt conventions for this project.
